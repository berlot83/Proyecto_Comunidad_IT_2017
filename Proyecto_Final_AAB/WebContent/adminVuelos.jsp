		...
		<tr>
			<td>
				<select id="menu" onchange="acciones(this.value)">
					...
					<option value="eliminarAvion">Eliminar un avión</option>
...
<div id="menus">
	...
	<table id="tablaEliminarAvion" style='display:none;'>
		<tr>
			<td>
				<label>Seleccione el avión a eliminar</label>
			</td>
		</tr>
		...
		<tr>
			<td>
				<select id="selectAvionesDisponiblesEliminar">
					<!-- Acá va texto dinámico desde DB por js -->
				</select>
			</td>
	...
	<table id="tablaAgregarVuelo" style='display:none;'>
		...
		<tr>
			<td>
				<select id="empresa">
					<!-- Acá va texto dinámico desde la DB por js -->
				</select>
			</td>
		...
		<tr>
			<td>
				<select id="modificarEmpresa">
					<!-- Acá aparecerá texto dinámico desde la DB por js -->
				</select>
			</td>
